...
public class BenchmarkCornerRuntime {
	...
	public static void main( String args[] ) {
		...
		while( sequence.next() ) {
			...
			derivX_F32.reshape(imgWidth,imgHeight);derivY_F32.reshape(imgWidth,imgHeight);
			derivX_I16.reshape(imgWidth,imgHeight);derivY_I16.reshape(imgWidth,imgHeight);
