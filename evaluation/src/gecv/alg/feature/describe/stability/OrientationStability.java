 ...
 * @author Peter Abeles
 */
public class OrientationStability<T extends ImageBase, D extends ImageBase> {
	...
	public OrientationStability(Class<T> imageType, Class<D> derivType) {
	...
	public static void main( String args[] ) {
		OrientationStability<ImageFloat32,ImageFloat32> benchmark
				= new OrientationStability<ImageFloat32,ImageFloat32>(ImageFloat32.class,ImageFloat32.class);
