...
//			fileName = "/home/pja/uav_video.avi";
		...
		GeneralFeatureDetector<ImageFloat32,ImageFloat32> detector =
				new GeneralFeatureDetector<ImageFloat32,ImageFloat32>(intensity,extractor,config.maxFeatures);
		...
		PyramidUpdateIntegerDown<ImageFloat32> pyrUpdater =
				new PyramidUpdateIntegerDown<ImageFloat32>(FactoryKernelGaussian.gaussian(Kernel1D_F32.class,-1,2),ImageFloat32.class);
