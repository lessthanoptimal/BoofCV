...
public class TestImplGrayImageOps {
	...
	@Test
	public void invert() {
		int numFound = GecvTesting.findMethodThenCall(this,"invert",ImplGrayImageOps.class,"invert");
	...
	public void brighten() {
		int numFound = GecvTesting.findMethodThenCall(this,"brighten",ImplGrayImageOps.class,"brighten");
		assertEquals(numExpected,numFound);
	}
	...
	@Test
	public void stretch() {
		int numFound = GecvTesting.findMethodThenCall(this,"stretch",ImplGrayImageOps.class,"stretch");
		assertEquals(numExpected,numFound);
	}
