...
public class FactoryKernel {
	 ...
	 *
	 * <p>
	 * See {@link gecv.alg.filter.convolve.ConvolveImageBox} for faster ways to convolve these kernels.
	 * </p>
	 *
	 ...
	 *
	 * <p>
	 * See {@link gecv.alg.filter.convolve.ConvolveImageBox} or {@link gecv.alg.filter.convolve.ConvolveImageMean} for faster ways to convolve these kernels.
	 * </p>
	 *
	 * @param radius kernel's radius.
	 * @return table kernel.
