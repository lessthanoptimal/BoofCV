...
public class GenerateConvertImage extends CodeGeneratorBase {
	...
	public void generate() throws FileNotFoundException {
		...
		for( TypeImage in : TypeImage.getSpecificTypes()) {
			for( TypeImage out : TypeImage.getSpecificTypes() ) {
				if( in == out )
					continue;
	...
	private void printPreamble() {
		...
		out.print("package gecv.core.image;\n" +
				"\n" +
	...
	private void printConvert( TypeImage imageIn , TypeImage imageOut ) {
		...
		out.print("\t/**\n" +
				"\t * <p>\n" +
				"\t * Converts an {@link gecv.struct.image."+imageIn.getImageName()+"} into a {@link gecv.struct.image."+imageOut.getImageName()+"}.\n" +
				"\t * </p>\n" +
				"\t *\n" +
