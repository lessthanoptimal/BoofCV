 ...
 * @author Peter Abeles
 */
public class GeneratorImageDistort extends CodeGeneratorBase {
	String className;
	...
	private void printPreamble() {
		...
		out.print("package gecv.alg.distort.impl;\n" +
				...
				" *\n" +
				" * <p>\n" +
				" * DO NOT MODIFY: Generated by {@link gecv.alg.distort.impl.GeneratorImageDistort}.\n" +
				" * </p>\n" +
				" *\n" +
				" * @author Peter Abeles\n" +
				" */\n" +
				"@SuppressWarnings({\"UnnecessaryLocalVariable\"})\n"+
				"public class "+className+" implements ImageDistort<"+imageName+"> {\n" +
				"\n" +
				...
				"\n" +
				"\tpublic "+className+"(PixelDistort dstToSrc, InterpolatePixel<"+imageName+"> interp) {\n" +
	...
	private void printInterpolation( boolean defaultValue )
	{
		...
		out.print("\t\tInputSanityCheck.checkSameShape(srcImg,dstImg);\n" +
				"\n" +
		...
		out.print("\t\tfinal int width = srcImg.getWidth();\n" +
	...
	public static void main( String args[] ) throws FileNotFoundException {
		GeneratorImageDistort gen = new GeneratorImageDistort();
		gen.generate();
	}
}
