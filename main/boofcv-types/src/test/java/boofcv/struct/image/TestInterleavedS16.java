...
public class TestInterleavedS16 extends StandardImageInterleavedTests<InterleavedS16> {
	...
	@Override
	public InterleavedS16 createImage(int width, int height, int numBands) {
		return new InterleavedS16(width, height, numBands);
	}

	@Override
	public InterleavedS16 createImage() {
		return new InterleavedS16();
	}

	@Override
	public Number randomNumber() {
		return (short)rand.nextInt(0x10000);
	}
	...
	@Test void forEachPixel() {
		var img = new InterleavedS16(2, 3, 4);
		setRandom(img);
