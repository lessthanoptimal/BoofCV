...
class TestSceneWorkingGraph extends BoofStandardJUnit {
	...
	@Test void setTo() {
		...
		expected.addView(new PairwiseImageGraph.View("1"));
		expected.addView(new PairwiseImageGraph.View("2"));
	...
	@Test void View_setTo() {
		...
		assertEquals(expected.intrinsic.f, found.intrinsic.f);
