...
public class GenerateDisparityScoreSadRect extends CodeGeneratorBase {
	...
	private void printPreamble() {
		out.print("import boofcv.alg.InputSanityCheck;\n" +
				...
				"/**\n" +
				" * <p>\n" +
				" * Implementation of {@link boofcv.alg.feature.disparity.DisparityScoreSadRect} which processes {@limk "+typeInput+"} as\n" +
				" * input images.\n" +
				" * </p>\n" +
				" * <p>\n" +
	...
	private void printComputeScoreRow() {
		out.print("\t/**\n" +
	...
	private void printTheRest() {
		out.print("\t/**\n" +
				...
				"\t * inserted easily.\n" +
				"\t */\n" +
				"\tprotected void computeScoreRow("+typeInput+" left, "+typeInput+" right,\n" +
