 ...
 * @author Peter Abeles
 */
public class DescribeImageDenseHoGFast<T extends ImageBase> implements DescribeImageDense<T,TupleDesc_F64> {

	DescribeDenseHogFastAlg<T> hog;

	public DescribeImageDenseHoGFast(DescribeDenseHogFastAlg<T> hog) {
		this.hog = hog;
	}
