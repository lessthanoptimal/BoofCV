 ...
 * @author Peter Abeles
 */
public class DescribeImageDenseHoGOrig<T extends ImageBase> implements DescribeImageDense<T,TupleDesc_F64> {

	DescribeDenseHogOrigAlg<T> hog;

	public DescribeImageDenseHoGOrig(DescribeDenseHogOrigAlg<T> hog) {
		this.hog = hog;
	}
