 ...
 * @author Peter Abeles
 */
public class ImplDescribePointBrief_U16 extends DescribePointBrief<ImageUInt16> {

	public ImplDescribePointBrief_U16(BriefDefinition definition, BlurFilter<ImageUInt16> filterBlur) {
	...
	public boolean process( int c_x , int c_y , BriefFeature feature )
	{
		...
		for( int i = 0; i < definition.setA.length; i++ ) {
			int valA = blur.data[index+offsetsA[i]]& 0xFFFF;
			int valB = blur.data[index+offsetsB[i]]& 0xFFFF;
