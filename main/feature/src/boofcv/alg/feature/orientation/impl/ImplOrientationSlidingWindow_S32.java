 ...
 * @author Peter Abeles
 */
public class ImplOrientationSlidingWindow_S32 extends OrientationSlidingWindow<ImageSInt32> {

	public ImplOrientationSlidingWindow_S32(int numAngles, double windowSize, boolean isWeighted) {
