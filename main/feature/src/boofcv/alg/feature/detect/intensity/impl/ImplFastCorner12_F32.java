 ...
 * @author Peter Abeles
 */
public class ImplFastCorner12_F32 implements FastCornerIntensity<ImageFloat32> {
	 ...
	 */
	public ImplFastCorner12_F32( float pixelTol, int minCont) {
	...
	@Override
	public void process( ImageFloat32 img , ImageFloat32 featureIntensity ) {
		candidates.reset();
