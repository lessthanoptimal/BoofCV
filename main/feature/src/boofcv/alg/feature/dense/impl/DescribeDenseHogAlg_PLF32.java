 ...
 */
@Generated("")
public class DescribeDenseHogAlg_PLF32 extends DescribeDenseHogAlg
		<Planar<GrayF32>,Planar<GrayF32>>
{
	...
	public DescribeDenseHogAlg_PLF32(int orientationBins, int widthCell, int widthBlock, int stepBlock, int numBands ) {
		super(orientationBins, widthCell, widthBlock, stepBlock , ImageType.pl(numBands,GrayF32.class));
