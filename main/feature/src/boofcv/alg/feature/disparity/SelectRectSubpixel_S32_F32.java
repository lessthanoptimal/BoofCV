...
/**
 * <p>
 * Implementation of {@link SelectRectStandardBase_S32} that adds sub-pixel accuracy. Using
 ...
 * @author Peter Abeles
 */
public class SelectRectSubpixel_S32_F32 extends SelectRectStandardBase_S32<ImageFloat32> {

	public SelectRectSubpixel_S32_F32(int maxError, int rightToLeftTolerance, double texture) {
