 ...
 * @author Peter Abeles
 */
public class MergeSmallRegionsSlic<T extends ImageBase> extends RegionMergeTree {
	 ...
	 */
	protected boolean setupPruneList(GrowQueue_I32 regionMemberCount, int minimumSize ) {
	 ...
	 */
	protected void selectMerge( int pruneId , GrowQueue_I32 regionMemberCount ) {
		...
		for( int i = 0; i < n.edges.size; i++ ) {
			...
			int count = regionMemberCount.get(i);
