 ...
 * @author Peter Abeles
 */
public class TestBackgroundMovingBasic_PL extends GenericBackgroundMovingBasicChecks {
	public TestBackgroundMovingBasic_PL() {
	...
	create(ImageType<T> imageType) {
		...
		return new BackgroundMovingBasic_PL(0.05f, 10f, transform, TypeInterpolate.BILINEAR, imageType);
	}
}
