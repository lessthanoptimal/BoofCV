 ...
 * @author Peter Abeles
 */
public class TestDescribeDenseHogAlg_F32 extends GenericDescribeDenseHogAlgChecks<GrayF32>
{
	...
	@Override
	public DescribeDenseHogAlg<GrayF32,?> createAlg(int orientationBins, int widthCell, int widthBlock, int stepBlock) {
