 ...
 * @author Peter Abeles
 */
public class TestDescribeDenseHogAlg_PLF32 extends GenericDescribeDenseHogAlgChecks<Planar<GrayF32>>
{
	public TestDescribeDenseHogAlg_PLF32() {
	...
	{
		return new DescribeDenseHogAlg_PLF32(orientationBins,widthCell,widthBlock,stepBlock,3);
	}
}