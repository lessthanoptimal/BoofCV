 ...
 * @author Peter Abeles
 */
public class TestImplKltCornerWeighted_S16 {
	int width = 15;
	int height = 20;
	...
	public void genericTests() {
		GenericCornerIntensityTests generic = new GenericCornerIntensityGradientTests(){
			...
			public ImageFloat32 computeIntensity() {
				ImplKltCornerWeighted_S16 alg = new ImplKltCornerWeighted_S16(1);
	...
	public void compareToNaive(ImageSInt16 derivX, ImageSInt16 derivY) {
		...
		ImplKltCornerWeighted_S16 fast = new ImplKltCornerWeighted_S16(3);
