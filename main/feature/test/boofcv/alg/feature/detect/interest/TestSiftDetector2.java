 ...
 * @author Peter Abeles
 */
public class TestSiftDetector2 {
	...
	public void process() {
		...
		SiftDetector2 alg = createDetector();
	...
	private SiftDetector2 createDetector() {
		SiftScaleSpace2 ss = new SiftScaleSpace2(-1,5,3,1.6);
		...
		return new SiftDetector2(ss,10,limiter);
	}
