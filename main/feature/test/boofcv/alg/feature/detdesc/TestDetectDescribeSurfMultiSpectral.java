...
public class TestDetectDescribeSurfMultiSpectral {
	...
	public void basicTest() {
		...
		DescribePointSurfMultiSpectral<GrayF32> descMulti = new DescribePointSurfMultiSpectral<GrayF32>(desc,3);
		...
		DetectDescribeSurfMultiSpectral<GrayF32> alg =
				new DetectDescribeSurfMultiSpectral<GrayF32>(detector,orientation,descMulti);
