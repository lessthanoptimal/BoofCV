 ...
 * @author Peter Abeles
 */
public class TestStereoDisparityWtoNaiveFive {
	...
	public void basicTest() {
		BasicDisparityTests<ImageUInt8,ImageFloat32> alg =
				new BasicDisparityTests<ImageUInt8,ImageFloat32>(ImageUInt8.class) {
					...
					StereoDisparityWtoNaiveFive<ImageUInt8> alg;
					...
					public void initialize(int minDisparity , int maxDisparity) {
						alg = new StereoDisparityWtoNaiveFive<ImageUInt8>(minDisparity,maxDisparity,2,3);
					}
