 ...
 * @author Peter Abeles
 */
public abstract class ChecksImplDisparityScoreSadRectFive<Image extends ImageSingleBand,Disparity extends ImageSingleBand> {
	...
	public ChecksImplDisparityScoreSadRectFive(Class<Image> imageType, Class<Disparity> disparityType) {
	...
	protected abstract DisparityScoreWindowFive<Image,Disparity>
	...
	public void basicTest() {
		BasicDisparityTests<Image,Disparity> alg =
				new BasicDisparityTests<Image,Disparity>(imageType) {
					...
					DisparityScoreWindowFive<Image,Disparity> alg;
