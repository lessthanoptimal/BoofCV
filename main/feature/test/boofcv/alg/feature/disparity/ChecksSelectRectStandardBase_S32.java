 ...
 * @author Peter Abeles
 */
public abstract class ChecksSelectRectStandardBase_S32<T extends ImageSingleBand> {
	...
	public ChecksSelectRectStandardBase_S32( Class<T> imageType ) {
		this.imageType = imageType;
		disparity = GeneralizedImageOps.createSingleBand(imageType,w,h);
	}

	public abstract SelectRectStandardBase_S32<T> createSelector( int maxError, int rightToLeftTolerance, double texture );

	@Test
	public void basic() {
		BasicDisparitySelectRectTests<T> test =
				new BasicDisparitySelectRectTests<T>(imageType) {
					@Override
					public DisparitySelect_S32<T> createAlg() {
	...
	public void maxError() {
		...
		SelectRectStandardBase_S32<T> alg = createSelector(2,-1,-1);
	...
	public void testRightToLeftValidation() {
		...
		SelectRectStandardBase_S32<T> alg = createSelector(-1,1,-1);
		alg.configure(disparity,maxDisparity,2);
	...
	public void confidenceFlatRegion() {
		...
		SelectRectStandardBase_S32<T> alg = createSelector(-1,-1,3);
		alg.configure(disparity,maxDisparity,2);
