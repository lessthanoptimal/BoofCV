 ...
 * @author Peter Abeles
 */
public class TestSelectRectSubpixel_S32_F32 extends ChecksSelectRectStandardBase_S32<ImageFloat32>{
	...
	@Override
	public SelectRectStandardBase_S32<ImageFloat32> createSelector(int maxError, int rightToLeftTolerance, double texture) {
		return new SelectRectSubpixel_S32_F32(maxError,rightToLeftTolerance,texture);
	}
	...
	public void addSubpixelBias() {
		...
		SelectRectSubpixel_S32_F32 alg = new SelectRectSubpixel_S32_F32(-1,-1,-1);
