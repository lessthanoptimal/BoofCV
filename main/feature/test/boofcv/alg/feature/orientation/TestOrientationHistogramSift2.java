 ...
 * @author Peter Abeles
 */
public class TestOrientationHistogramSift2 {
	...
	public void process_easy( ImageFloat32 derivX, ImageFloat32 derivY ) {
		...
		OrientationHistogramSift2 alg = new OrientationHistogramSift2(36, 2.5, 1);
	...
	private void checkHistogram(int n, OrientationHistogramSift2 alg, double theta, int index) {
		for (int i = 0; i < n; i++) {
			if (i == index) {
