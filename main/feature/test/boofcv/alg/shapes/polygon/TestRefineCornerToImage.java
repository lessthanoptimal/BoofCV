 ...
 * @author Peter Abeles
 */
public class TestRefineCornerToImage {
	...
	public void perfectInitial() {
		for( Class imageType : imageTypes ) {
			for (int i = 0; i < 2; i++) {
				perfectInitial(i==0,imageType);
			}
		}
	}

	public void perfectInitial( boolean black , Class imageType ) {
		fail("implement");
	}
	...
	@Test
	public void optimize_right() {
		fail("implement");
	}


	@Test
	public void optimize_left() {
		fail("implement");
	}
