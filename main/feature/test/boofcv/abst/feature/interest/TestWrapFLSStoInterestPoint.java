...
public class TestWrapFLSStoInterestPoint extends GeneralInterestPointDetectorChecks {
	...
	FeatureLaplaceScaleSpace flss = FactoryInterestPointAlgs.hessianLaplace(3, 1, 200, imageType, derivType);

	public TestWrapFLSStoInterestPoint() {
		GaussianScaleSpace ss = FactoryGaussianScaleSpace.nocache(imageType);
		ss.setScales(scales);

		configure(new WrapFLSStoInterestPoint(flss, ss), false, true, imageType);
	}
}
