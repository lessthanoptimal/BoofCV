...
public class TestDetectChessCalibrationPoints2 {
...
//		detectorSquare.setVerbose(true);
		...
		DetectChessboardFiducial2 alg =
				new DetectChessboardFiducial2(numRows, numCols, 4,detectorSquare,null,null,inputToBinary);
