...
public class TestSquaresIntoClusters {
	...
	public void process() {
		...
		SquaresIntoClusters alg = new SquaresIntoClusters(1.0,6, 1.35);
	...
	public void computeNodeInfo() {
		...
		SquaresIntoClusters alg = new SquaresIntoClusters(2,6, 1.35);
	...
	public void checkConnect() {
		...
		SquaresIntoClusters alg = new SquaresIntoClusters(0.1,6, 1.35);
