 ...
 * assumed to be known and fixed.  Bundle adjustment will optimize both the cameras
 * extrinsic parameters and the world's structure (point locations) at the same
 * time.
 *
 * @author Peter Abeles
 */
