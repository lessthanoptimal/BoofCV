 ...
 * Then it applies another transformation which is passed in. The coordinate transform is the
 * following: y = height - y - 1
 * </p>
 *
 * <p>
 ...
 * @author Peter Abeles
 */
public class LeftToRightHandedNorm_F64 implements PointTransform_F64 {

	PointTransform_F64 pixelToNormalized;
	int height;

	public LeftToRightHandedNorm_F64(PointTransform_F64 pixelToNormalized, int imageHeight) {
