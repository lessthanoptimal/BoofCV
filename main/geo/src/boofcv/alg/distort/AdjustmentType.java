...
public enum AdjustmentType {
	 ...
	 * regions around the border.  The advantage is that there are no edge conditions when image processing due
	 * to the black border, but you will discard information.
	 */
	ALL_INSIDE
	// TODO rename to NO_BORDER?  Need to hunt down all references
}
