 ...
 * @author Peter Abeles
 */
public class PoseResidualsSimple implements ModelObservationResidualN<Se3_F64,PointPosePair> {
	...
	@Override
	public int computeResiduals(PointPosePair obs, double[] residuals, int index) {
