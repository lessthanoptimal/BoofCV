...
public class BenchmarkRefineFundamental extends ArtificialStereoScene{
	...
	public void runAll() {
		...
		ProfileOperation.printOpsPerSec(new Refine(FactoryEpipolar.refineFundamental(tol,MAX_ITER, EpipolarError.SAMPSON)), TEST_TIME);
		ProfileOperation.printOpsPerSec(new Refine(new QuasiNewtonFundamentalSampson(tol,MAX_ITER)), TEST_TIME);
