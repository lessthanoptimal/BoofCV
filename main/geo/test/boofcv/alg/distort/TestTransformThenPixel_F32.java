...
public class TestTransformThenPixel_F32 {
	@Test
	public void set() {
		TransformThenPixel_F32 alg = new TransformThenPixel_F32(null);
	...
	@Test
	public void compute() {
		TransformThenPixel_F32 alg = new TransformThenPixel_F32(new Dummy());
		alg.set(1, 2, 3, 4, 5);
	...
	protected static class Dummy implements PointTransform_F32 {
