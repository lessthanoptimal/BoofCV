 ...
 * @author Peter Abeles
 */
public class TestCalibrationDetectorChessboard extends GenericDetectSingleFiducialCalibrationChecks {
...
//		BoofMiscOps.sleep(100000);
	...
	public DetectSingleFiducialCalibration createDetector( ConfigGridDimen layout) {
		return FactoryFiducialCalibration.chessboardX((ConfigChessboardX)null,layout);
	}
}
