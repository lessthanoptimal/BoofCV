...
public class MicroQrPose3DUtils {
	...
	public List<PointIndex2D_F64> getLandmarkByIndex( MicroQrCode qr ) {
		pixelControl.get(0).p.setTo(qr.pp.get(0));
		pixelControl.get(1).p.setTo(qr.pp.get(1));
		pixelControl.get(2).p.setTo(qr.pp.get(2));
		pixelControl.get(3).p.setTo(qr.pp.get(3));
	...
	public List<Point2D3D> getLandmark2D3D( MicroQrCode qr ) {
		...
		setPair(0, 0, 0, N, qr.pp.get(0));
		setPair(1, 0, 7, N, qr.pp.get(1));
		setPair(2, 7, 7, N, qr.pp.get(2));
		setPair(3, 7, 0, N, qr.pp.get(3));
