...
public interface AztecCodeDetector<T extends ImageGray<T>> {
	 ...
	 *
	 * @return List of detection. WARNING: Data might be recycled on next call to {@link #process}
	 */
	 ...
	 *
	 * @return List of rejected candidates. WARNING: Data might be recycled on next call to {@link #process}
	 */
