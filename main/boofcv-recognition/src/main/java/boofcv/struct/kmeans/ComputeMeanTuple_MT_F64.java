...
public class ComputeMeanTuple_MT_F64 extends ComputeMeanTuple_F64 {
	...
	final BoofLambdas.Factory<TupleDesc_F64> factory;
	GrowArray<ThreadData> threadData;

	public ComputeMeanTuple_MT_F64( BoofLambdas.Factory<TupleDesc_F64> factory ) {
	...
	@Override public ComputeMeanClusters<TupleDesc_F64> newInstanceThread() {
		return new ComputeMeanTuple_MT_F64(factory); // TODO is this going to be thread safe?
	}

	class ThreadData {
		TupleDesc_F64 point = factory.newInstance();
		DogArray_I32 counts = new DogArray_I32();
		DogArray<TupleDesc_F64> clusterSums = new DogArray<>(factory::newInstance);
	}
}
