...
public class FactoryTrackerObjectQuad {
	...
	TrackerObjectQuad<T> tld( ConfigTrackerTld config, Class<T> imageType ) {
		if (config == null)
	 ...
	 */
	public static <T extends ImageGray<T>, D extends ImageGray<D>>
	TrackerObjectQuad<T> sparseFlow( @Nullable ConfigSfot config, Class<T> imageType, @Nullable Class<D> derivType ) {
