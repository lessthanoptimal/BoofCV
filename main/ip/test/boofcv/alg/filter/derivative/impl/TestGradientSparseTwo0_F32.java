 ...
 * @author Peter Abeles
 */
public class TestGradientSparseTwo0_F32 extends GeneralGradientSparse {

	public TestGradientSparseTwo0_F32() {
	...
	public ImageGradient createGradient() {
		return FactoryDerivative.two0(imageType, derivType);
	}
