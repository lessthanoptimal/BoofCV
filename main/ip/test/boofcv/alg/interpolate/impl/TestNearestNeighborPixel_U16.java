 ...
 * @author Peter Abeles
 */
public class TestNearestNeighborPixel_U16 extends GeneralInterpolationPixelChecks<ImageUInt16>
{
	@Override
	...
	@Override
	protected InterpolatePixel<ImageUInt16> wrap(ImageUInt16 image, int minValue, int maxValue) {
