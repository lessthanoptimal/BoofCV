...
public class PixelMath {
	 ...
	 */
	public static void bandAve( MultiSpectral<ImageUInt8> input , ImageUInt8 output ) {
	 ...
	 * @param output Gray scale image containing average pixel values
	 */
	public static void bandAve( MultiSpectral<ImageSInt8> input , ImageSInt8 output ) {
		final int h = input.getHeight();
		final int w = input.getWidth();
	 ...
	 * @param output Gray scale image containing average pixel values
	 */
	public static void bandAve( MultiSpectral<ImageUInt16> input , ImageUInt16 output ) {
		final int h = input.getHeight();
		final int w = input.getWidth();
	 ...
	 * @param output Gray scale image containing average pixel values
	 */
	public static void bandAve( MultiSpectral<ImageSInt16> input , ImageSInt16 output ) {
		final int h = input.getHeight();
		final int w = input.getWidth();
	 ...
	 * @param output Gray scale image containing average pixel values
	 */
	public static void bandAve( MultiSpectral<ImageSInt32> input , ImageSInt32 output ) {
		final int h = input.getHeight();
		final int w = input.getWidth();
	 ...
	 * @param output Gray scale image containing average pixel values
	 */
	public static void bandAve( MultiSpectral<ImageSInt64> input , ImageSInt64 output ) {
		final int h = input.getHeight();
		final int w = input.getWidth();
	 ...
	 * @param output Gray scale image containing average pixel values
	 */
	public static void bandAve( MultiSpectral<ImageFloat32> input , ImageFloat32 output ) {
		final int h = input.getHeight();
		final int w = input.getWidth();
	 ...
	 * @param output Gray scale image containing average pixel values
	 */
	public static void bandAve( MultiSpectral<ImageFloat64> input , ImageFloat64 output ) {
		final int h = input.getHeight();
		final int w = input.getWidth();
