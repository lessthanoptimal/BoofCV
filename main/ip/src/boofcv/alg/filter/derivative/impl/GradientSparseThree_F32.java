 ...
 * @author Peter Abeles
 */
public class GradientSparseThree_F32 implements SparseImageGradient<ImageFloat32,GradientValue_F32> {
	...
	public GradientValue_F32 compute(int x, int y) {
		...
		gradient.y = (a21-a01)*0.5f;
		gradient.x = (a12-a10)*0.5f;
