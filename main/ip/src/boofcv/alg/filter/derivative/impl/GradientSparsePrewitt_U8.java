 ...
 * @author Peter Abeles
 */
public class GradientSparsePrewitt_U8 implements SparseImageGradient<ImageUInt8,GradientValue_I32> {
	 ...
	 */
	public GradientSparsePrewitt_U8(ImageBorder_I32<ImageUInt8> border) {
		this.border = border;
	}
