 ...
 * @author Peter Abeles
 */
public class GradientSparseTwo1_U8 implements SparseImageGradient<ImageUInt8,GradientValue_I32> {
	 ...
	 */
	public GradientSparseTwo1_U8(ImageBorder_I32<ImageUInt8> border) {
		this.border = border;
	}
