...
/// based off the 5 region algorithm described in \[1\]. Five overlapping regions are considered and the error at each
...
/// [DisparityBlockMatch]. Unlike those classes, a rolling window of scores for rectangular regions
...
public abstract class DisparityBlockMatchBestFive<I extends ImageBase<I>, DI extends ImageGray<DI>>
	...
	protected DisparityBlockMatchBestFive( int regionRadiusX, int regionRadiusY, ImageType<I> imageType ) {
