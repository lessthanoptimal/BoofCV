...
/// Computes the Sum of Squared Difference (SSD) for block matching based algorithms.
public interface BlockRowScoreSsd {
	abstract class SsdArrayS32<T extends GrayI<T>, ImageData> extends BlockRowScore.ArrayS32_BS32<T, ImageData> {
		SsdArrayS32( int maxPerPixel ) {
			super(maxPerPixel);
		}
	...
	abstract class SsdArrayF32 extends BlockRowScore.ArrayS32_BF32 {
		@Override
		public boolean isRequireNormalize() {
			return false;
		}
	...
	class U8 extends SsdArrayS32<GrayU8, byte[]> {
		public U8() {
			super(255*255);
		}
	...
	class U16 extends SsdArrayS32<GrayU16, short[]> {
		public U16() {
			super(-1);
		}
	...
	class S16 extends SsdArrayS32<GrayS16, short[]> {
		public S16() {
			super(-1);
		}
		...
		public void score( short[] leftRow, short[] rightRow, int indexLeft, int indexRight, int offset, int length, int[] elementScore ) {
			for (int rCol = 0; rCol < length; rCol++) {
				...
				elementScore[offset + rCol] = difference*difference;
			}
		}
