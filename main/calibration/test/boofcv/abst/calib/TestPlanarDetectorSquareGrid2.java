 ...
 * @author Peter Abeles
 */
public class TestPlanarDetectorSquareGrid2 extends GenericPlanarCalibrationDetectorChecks {

	private final static ConfigSquareGrid2 config = new ConfigSquareGrid2(3, 5, 30,30);


	@Test
	public void createLayout() {
		List<Point2D_F64> l = PlanarDetectorSquareGrid2.createLayout(3, 5, 0.1, 0.2);
	...
	public PlanarCalibrationDetector createDetector() {
		return FactoryPlanarCalibrationTarget.detectorSquareGrid2(config);
	}
}