...
public class GenerateGPixelMath extends CodeGeneratorBase {
	...
	private AutoTypeImage[] standardTypes = new AutoTypeImage[]{U8,S8,U16,S16,S32,S64,F32,F64};
	private AutoTypeImage[] floatTypes = new AutoTypeImage[]{F32,F64};

	private AutoTypeImage[] signedTypes = new AutoTypeImage[]{S8,S16,S32,S64,F32,F64};
	...
	private void printFunction( Function f , AutoTypeImage[] typesIn, AutoTypeImage[] typesOut) {
		...
		singleBand = true;
		printSwitch(f,typesIn,typesOut,"\t\t\t");
		out.print(
