...
public class GenerateBilinearRectangle extends CodeGeneratorBase {
	...
	private void printTheRest() {
		...
		out.print("\t@Override public void setImage( " + image.getSingleBandName() + " image ) {\n" +
				"\t\tthis.orig = image;\n" +
				"\t\tthis.data = orig.data;\n" +
				"\t\tthis.stride = orig.getStride();\n" +
				"\t}\n" +
				"\n" +
				"\t@Override public " + image.getSingleBandName() + " getImage() {\n" +
				"\t\treturn orig;\n" +
				"\t}\n" +
				"\n" +
				...
				"\t}\n" +
				"\n" +
				"\t@Override public InterpolateRectangle<" + image.getSingleBandName() + "> copyConcurrent() {\n" +
	...
	public static void main( String[] args ) throws FileNotFoundException {
		var app = new GenerateBilinearRectangle();
