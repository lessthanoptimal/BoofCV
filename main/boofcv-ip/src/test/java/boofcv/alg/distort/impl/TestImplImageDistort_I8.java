 ...
 * @author Peter Abeles
 */
public class TestImplImageDistort_I8 extends GeneralImageDistortTests<GrayU8>{
	...
	@Override
	public ImageDistort<GrayU8,GrayU8> createDistort(PixelTransform<Point2D_F32> dstToSrc,
