...
public class TestGradientTwo1_Standard  extends BoofStandardJUnit {
	...
	@Test void compareToConvolve_I8() throws NoSuchMethodException {
		...
		validator.setKernel(0, GradientTwo1.kernel_I32,true);
		validator.setKernel(1, GradientTwo1.kernel_I32,false);
	...
	@Test void compareToConvolve_F32() throws NoSuchMethodException {
		...
		validator.setKernel(0, GradientTwo1.kernel_F32,true);
		validator.setKernel(1, GradientTwo1.kernel_F32,false);
