 ...
 * @author Peter Abeles
 */
public class TestConvolveImageUnrolled_SB_U16_I16_Div extends BoofStandardJUnit {
	...
	@Test void convolve() throws NoSuchMethodException {
		for (int i = 0; i < GenerateConvolvedUnrolled_SB.numUnrolled; i++) {
			Method m = ConvolveImageUnrolled_SB_U16_I16_Div.class.getMethod("convolve",
					Kernel2D_S32.class, GrayU16.class, GrayI16.class , int.class, GrowArray.class);
	...
	@Test void vertical() throws NoSuchMethodException {
		for (int i = 0; i < GenerateConvolvedUnrolled_SB.numUnrolled; i++) {
			Method m = ConvolveImageUnrolled_SB_U16_I16_Div.class.getMethod("vertical",
					Kernel1D_S32.class, GrayU16.class, GrayI16.class, int.class, GrowArray.class);
