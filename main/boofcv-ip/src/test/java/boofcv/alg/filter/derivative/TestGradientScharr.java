 ...
 * @author Peter Abeles
 */
public class TestGradientScharr extends BoofStandardJUnit {
	int width = 20;
	int height = 25;

	@Test void testStandard() {
		StandardGradientChecks standard = new StandardGradientChecks();
		standard.secondDerivativeTest(GradientScharr.class, 3);
	}

	@Test void compareToConvolve_I8() throws NoSuchMethodException {
		CompareDerivativeToConvolution validator = new CompareDerivativeToConvolution();
		validator.setTarget(GradientScharr.class.getMethod("process",
