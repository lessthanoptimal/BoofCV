...
public class TestConvolveDownNoBorderUnrolled_S16_I16 extends StandardConvolveUnrolledTests {
	...
	public TestConvolveDownNoBorderUnrolled_S16_I16() {
		...
		this.param1D = new Class<?>[]{Kernel1D_S32.class, GrayS16.class, GrayI16.class , int.class };
		this.param2D = new Class<?>[]{Kernel2D_S32.class, GrayS16.class, GrayI16.class , int.class };
	}
}
