 ...
 * @author Peter Abeles
 */
public abstract class GenericThresholdSquareBlockMeanChecks
		<T extends ImageGray<T>>
{
	...
	public GenericThresholdSquareBlockMeanChecks(Class<T> imageType) {
		this.imageType = imageType;
	}

	public abstract ThresholdSquareBlockMean<T> createAlg( int requestedBlockWidth,
	...
	public void widthLargerThanImage() {
		...
		ThresholdSquareBlockMean<T> alg = createAlg(20,1.0,true);
	...
	public void subImage() {
		...
		ThresholdSquareBlockMean<T> alg = createAlg(14,1.0,true);
