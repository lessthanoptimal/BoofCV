...
public class ImplImageDistort_F32<Input extends ImageGray<Input>>
		extends ImageDistortBasic_SB<Input,GrayF32> {

	public ImplImageDistort_F32( InterpolatePixelS<Input> interp) {
		super(interp);
	}
