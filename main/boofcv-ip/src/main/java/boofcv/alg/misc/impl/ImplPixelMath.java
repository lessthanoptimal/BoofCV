...
public class ImplPixelMath {
	...
	public static void lambda1( byte[] input, int inputStart, int inputStride,
	...
	public static void lambda1( short[] input, int inputStart, int inputStride,
	...
	public static void lambda1( int[] input, int inputStart, int inputStride,
	...
	public static void lambda1( long[] input, int inputStart, int inputStride,
	...
	public static void lambda1( float[] input, int inputStart, int inputStride,
	...
	public static void lambda1( double[] input, int inputStart, int inputStride,
	...
	public static void lambda2( byte[] inputA, int inputStartA, int inputStrideA,
	...
	public static void lambda2( short[] inputA, int inputStartA, int inputStrideA,
	...
	public static void lambda2( int[] inputA, int inputStartA, int inputStrideA,
	...
	public static void lambda2( long[] inputA, int inputStartA, int inputStrideA,
	...
	public static void lambda2( float[] inputA, int inputStartA, int inputStrideA,
	...
	public static void lambda2( double[] inputA, int inputStartA, int inputStrideA,
