...
public class GradientSparseTwo0_F32 implements SparseImageGradient<GrayF32, GradientValue_F32> {
	...
	@Override public GradientValue_F32 compute( int x, int y ) {
		float a00, a10, a01;
	...
	@Override public Class<GradientValue_F32> getGradientType() {
		return GradientValue_F32.class;
	}

	@Override public void setImage( GrayF32 input ) {
		this.input = input;
		if (border != null) {
