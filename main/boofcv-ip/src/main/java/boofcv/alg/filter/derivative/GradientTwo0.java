...
import boofcv.alg.filter.derivative.impl.GradientTwo0_Standard_MT;
...
/// Forward difference image derivative. `[-1 1]` kernel, where the "center" of the kernel is on the -1.
/// This kernel causes a +0.5 pixel shift in image gradient, which is undesirable in most application.
///
...
///
/// ```
/// derivX(x,y) = img(x+1,y) - img(x,y)
/// derivY(x,y) = img(x,y+1) - img(x,y)
/// ```
public class GradientTwo0 {
	...
	public static Kernel1D_S32 kernelDiff = new Kernel1D_S32(2, 0, new int[]{-1, 1});
	public static Kernel1D_S32 kernel_I32 = new Kernel1D_S32(2, 0, new int[]{-1, 1});
	public static Kernel1D_F32 kernel_F32 = new Kernel1D_F32(2, 0, new float[]{-1, 1});
