...
/**
 * Implementation of {@link ThresholdSquareBlockMean} for input images of type {@link GrayU8}
 *
 * @author Peter Abeles
 */
public class ThresholdSquareBlockMean_F32
	extends ThresholdSquareBlockMean<GrayF32>
{
	float scale;
	boolean down;

	public ThresholdSquareBlockMean_F32(int requestedBlockWidth, double scale , boolean down ) {
