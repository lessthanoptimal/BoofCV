...
public class ConvolveImageUnrolled_SB_U8_I8_Div {
	...
	public static boolean convolve( Kernel2D_S32 kernel ,
								   GrayU8 image, GrayI8 dest, int divisor , IWorkArrays work) {
	...
	public static void convolve3( Kernel2D_S32 kernel, GrayU8 src, GrayI8 dest , int divisor , IWorkArrays work )
	{
		if( work == null ) {
	...
	public static void convolve5( Kernel2D_S32 kernel, GrayU8 src, GrayI8 dest , int divisor , IWorkArrays work )
	{
		if( work == null ) {
			work = new IWorkArrays(src.width);
		} else {
	...
	public static void convolve7( Kernel2D_S32 kernel, GrayU8 src, GrayI8 dest , int divisor , IWorkArrays work )
	{
		if( work == null ) {
			work = new IWorkArrays(src.width);
		} else {
	...
	public static void convolve9( Kernel2D_S32 kernel, GrayU8 src, GrayI8 dest , int divisor , IWorkArrays work )
	{
		if( work == null ) {
			work = new IWorkArrays(src.width);
		} else {
	...
	public static void convolve11( Kernel2D_S32 kernel, GrayU8 src, GrayI8 dest , int divisor , IWorkArrays work )
	{
		if( work == null ) {
			work = new IWorkArrays(src.width);
		} else {
