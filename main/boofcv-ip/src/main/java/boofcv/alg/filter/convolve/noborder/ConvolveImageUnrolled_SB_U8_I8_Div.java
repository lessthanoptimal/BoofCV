...
public class ConvolveImageUnrolled_SB_U8_I8_Div {
	...
	public static boolean convolve( Kernel2D_S32 kernel ,
								   GrayU8 image, GrayI8 dest, int divisor , GrowArray<GrowQueue_I32> work) {
	...
	public static void convolve3( Kernel2D_S32 kernel, GrayU8 src, GrayI8 dest , int divisor , @Nullable GrowArray<GrowQueue_I32> workspaces ) {
	...
	public static void convolve5( Kernel2D_S32 kernel, GrayU8 src, GrayI8 dest , int divisor , @Nullable GrowArray<GrowQueue_I32> workspaces ) {
		workspaces = BoofMiscOps.checkDeclare(workspaces, GrowQueue_I32::new);
		final GrowQueue_I32 work = workspaces.grow(); //CONCURRENT_REMOVE_LINE
		final byte[] dataSrc = src.data;
		final byte[] dataDst = dest.data;
	...
	public static void convolve7( Kernel2D_S32 kernel, GrayU8 src, GrayI8 dest , int divisor , @Nullable GrowArray<GrowQueue_I32> workspaces ) {
		workspaces = BoofMiscOps.checkDeclare(workspaces, GrowQueue_I32::new);
		final GrowQueue_I32 work = workspaces.grow(); //CONCURRENT_REMOVE_LINE
		final byte[] dataSrc = src.data;
		final byte[] dataDst = dest.data;
	...
	public static void convolve9( Kernel2D_S32 kernel, GrayU8 src, GrayI8 dest , int divisor , @Nullable GrowArray<GrowQueue_I32> workspaces ) {
		workspaces = BoofMiscOps.checkDeclare(workspaces, GrowQueue_I32::new);
		final GrowQueue_I32 work = workspaces.grow(); //CONCURRENT_REMOVE_LINE
		final byte[] dataSrc = src.data;
		final byte[] dataDst = dest.data;
	...
	public static void convolve11( Kernel2D_S32 kernel, GrayU8 src, GrayI8 dest , int divisor , @Nullable GrowArray<GrowQueue_I32> workspaces ) {
		workspaces = BoofMiscOps.checkDeclare(workspaces, GrowQueue_I32::new);
		final GrowQueue_I32 work = workspaces.grow(); //CONCURRENT_REMOVE_LINE
		final byte[] dataSrc = src.data;
		final byte[] dataDst = dest.data;
