 ...
 * @author Peter Abeles
 */
public class ThresholdSquareBlockMean_U8
	extends ThresholdSquareBlockMean<GrayU8>
{
	double scale;
	boolean down;

	public ThresholdSquareBlockMean_U8(int requestedBlockWidth, double scale , boolean down ) {
