 ...
 * 
 * <p>
 * DO NOT MODIFY.  This class was automatically generated by GenerateConvolvedUnrolled_SB.
 * </p>
 *
 * @author Peter Abeles
 */
...
public class ConvolveImageUnrolled_SB_U16_I16_Div {
	...
	public static boolean convolve( Kernel2D_S32 kernel ,
								   GrayU16 image, GrayI16 dest, int divisor , IWorkArrays work) {
	...
	public static void convolve3( Kernel2D_S32 kernel, GrayU16 src, GrayI16 dest , int divisor , IWorkArrays work )
	{
		if( work == null ) {
		...
		//CONCURRENT_BELOW BoofConcurrency.loopBlocks(kernelRadius, height-kernelRadius, kernelWidth,(y0,y1)->{
	...
	public static void convolve5( Kernel2D_S32 kernel, GrayU16 src, GrayI16 dest , int divisor , IWorkArrays work )
	{
		if( work == null ) {
			work = new IWorkArrays(src.width);
		} else {
	...
	public static void convolve7( Kernel2D_S32 kernel, GrayU16 src, GrayI16 dest , int divisor , IWorkArrays work )
	{
		if( work == null ) {
			work = new IWorkArrays(src.width);
		} else {
	...
	public static void convolve9( Kernel2D_S32 kernel, GrayU16 src, GrayI16 dest , int divisor , IWorkArrays work )
	{
		if( work == null ) {
			work = new IWorkArrays(src.width);
		} else {
	...
	public static void convolve11( Kernel2D_S32 kernel, GrayU16 src, GrayI16 dest , int divisor , IWorkArrays work )
	{
		if( work == null ) {
			work = new IWorkArrays(src.width);
		} else {
