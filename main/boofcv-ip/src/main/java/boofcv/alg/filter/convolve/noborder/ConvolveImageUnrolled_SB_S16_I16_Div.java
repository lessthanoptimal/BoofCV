...
public class ConvolveImageUnrolled_SB_S16_I16_Div {
	...
	public static void vertical3( Kernel1D_S32 kernel , GrayS16 image, GrayI16 dest , int divisor, @Nullable GrowArray<DogArray_I32> workspaces )
	{
		final short[] dataSrc = image.data;
		final short[] dataDst = dest.data;
	...
	public static void vertical5( Kernel1D_S32 kernel , GrayS16 image, GrayI16 dest , int divisor, @Nullable GrowArray<DogArray_I32> workspaces )
	{
		final short[] dataSrc = image.data;
		final short[] dataDst = dest.data;
	...
	public static void vertical7( Kernel1D_S32 kernel , GrayS16 image, GrayI16 dest , int divisor, @Nullable GrowArray<DogArray_I32> workspaces )
	{
		final short[] dataSrc = image.data;
		final short[] dataDst = dest.data;
	...
	public static void vertical9( Kernel1D_S32 kernel , GrayS16 image, GrayI16 dest , int divisor, @Nullable GrowArray<DogArray_I32> workspaces )
	{
		final short[] dataSrc = image.data;
		final short[] dataDst = dest.data;
	...
	public static void vertical11( Kernel1D_S32 kernel , GrayS16 image, GrayI16 dest , int divisor, @Nullable GrowArray<DogArray_I32> workspaces )
	{
		final short[] dataSrc = image.data;
		final short[] dataDst = dest.data;
