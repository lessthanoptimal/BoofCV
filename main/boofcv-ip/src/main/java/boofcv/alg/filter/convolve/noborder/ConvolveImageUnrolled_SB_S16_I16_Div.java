...
public class ConvolveImageUnrolled_SB_S16_I16_Div {
	...
	public static boolean convolve( Kernel2D_S32 kernel ,
								   GrayS16 image, GrayI16 dest, int divisor , GrowArray<GrowQueue_I32> work) {
	...
	public static void convolve3( Kernel2D_S32 kernel, GrayS16 src, GrayI16 dest , int divisor , @Nullable GrowArray<GrowQueue_I32> workspaces ) {
	...
	public static void convolve5( Kernel2D_S32 kernel, GrayS16 src, GrayI16 dest , int divisor , @Nullable GrowArray<GrowQueue_I32> workspaces ) {
		workspaces = BoofMiscOps.checkDeclare(workspaces, GrowQueue_I32::new);
		final GrowQueue_I32 work = workspaces.grow(); //CONCURRENT_REMOVE_LINE
		final short[] dataSrc = src.data;
		final short[] dataDst = dest.data;
	...
	public static void convolve7( Kernel2D_S32 kernel, GrayS16 src, GrayI16 dest , int divisor , @Nullable GrowArray<GrowQueue_I32> workspaces ) {
		workspaces = BoofMiscOps.checkDeclare(workspaces, GrowQueue_I32::new);
		final GrowQueue_I32 work = workspaces.grow(); //CONCURRENT_REMOVE_LINE
		final short[] dataSrc = src.data;
		final short[] dataDst = dest.data;
	...
	public static void convolve9( Kernel2D_S32 kernel, GrayS16 src, GrayI16 dest , int divisor , @Nullable GrowArray<GrowQueue_I32> workspaces ) {
		workspaces = BoofMiscOps.checkDeclare(workspaces, GrowQueue_I32::new);
		final GrowQueue_I32 work = workspaces.grow(); //CONCURRENT_REMOVE_LINE
		final short[] dataSrc = src.data;
		final short[] dataDst = dest.data;
	...
	public static void convolve11( Kernel2D_S32 kernel, GrayS16 src, GrayI16 dest , int divisor , @Nullable GrowArray<GrowQueue_I32> workspaces ) {
		workspaces = BoofMiscOps.checkDeclare(workspaces, GrowQueue_I32::new);
		final GrowQueue_I32 work = workspaces.grow(); //CONCURRENT_REMOVE_LINE
		final short[] dataSrc = src.data;
		final short[] dataDst = dest.data;
