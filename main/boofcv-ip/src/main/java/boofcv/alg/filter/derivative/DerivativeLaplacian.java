...
public class DerivativeLaplacian {
	/// The divisor is 1 because the formula used to derive this specific Laplacian uses central difference
	/// which divides by 1 twice
	public static final int divisor = 1;
	public static Kernel2D_S32 kernelXY_I32 = new Kernel2D_S32(3, new int[]{0, 1, 0, 1, -4, 1, 0, 1, 0});
	public static Kernel2D_F32 kernelXY_F32 = new Kernel2D_F32(3, new float[]{0, 1, 0, 1, -4, 1, 0, 1, 0});
	...
	public static void process( GrayU8 orig, GrayS16 deriv, @Nullable ImageBorder_S32<GrayU8> border ) {
		...
		if (border != null) {
			...
			ConvolveJustBorder_General_SB.convolve(kernelXY_I32, border, deriv);
		}
	}
...
//		}
	...
	public static void process( GrayF32 orig, GrayF32 deriv, @Nullable ImageBorder_F32 border ) {
		...
		if (border != null) {
			border.setImage(orig);
			ConvolveJustBorder_General_SB.convolve(kernelXY_F32, border, deriv);
		}
	}
}
