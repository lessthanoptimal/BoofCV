...
/// Backwards difference image derivative. `[-1 1]` kernel, where the "center" of the kernel is on the 1.
...
public class GradientTwo1 {
	...
	public static Kernel1D_S32 kernelDiff = new Kernel1D_S32(2, 1, new int[]{-1, 1});
	public static Kernel1D_S32 kernel_I32 = new Kernel1D_S32(2, 1, new int[]{-1, 1});
	public static Kernel1D_F32 kernel_F32 = new Kernel1D_F32(2, 1, new float[]{-1, 1});
