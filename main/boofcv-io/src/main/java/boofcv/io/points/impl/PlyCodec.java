...
public class PlyCodec {
	public static void saveAscii(PointCloudReader cloud , Writer outputWriter ) throws IOException {
	...
	public static void saveAsciiRgb(PointCloudReader cloud , Writer outputWriter ) throws IOException {
		outputWriter.write("ply\n");
		outputWriter.write("format ascii 1.0f\n");
		outputWriter.write("comment Created using BoofCV!\n");
		outputWriter.write("element vertex "+cloud.size()+"\n" +
	...
	public static void read(Reader inputReader, PointCloudWriter output ) throws IOException {
