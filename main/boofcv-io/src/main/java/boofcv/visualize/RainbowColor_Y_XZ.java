 ...
 * @author Peter Abeles
 */
public class RainbowColor_Y_XZ implements PointCloudViewer.Colorizer {

	double periodY;
	double periodXZ;

	public RainbowColor_Y_XZ(double periodY, double periodXZ) {
		this.periodY = periodY;
		this.periodXZ = periodXZ;
	}

	public RainbowColor_Y_XZ() {
	}
	...
	public int color(int index, double x, double y, double z) {
		...
		double b = Math.abs((x+z)/periodXZ - Math.floor((x+z)/periodXZ + 0.5));
	...
	public double getPeriodXZ() {
		return periodXZ;
	}

	public void setPeriodXZ(double periodXZ) {
		this.periodXZ = periodXZ;
	}
}
