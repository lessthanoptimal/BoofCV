...
class TestBackgroundMovingGaussian_PL_MT extends GenericBackgroundMovingThreadsChecks {
	public TestBackgroundMovingGaussian_PL_MT() {
	...
	create( boolean singleThread, ImageType<T> imageType ) {
		...
		if (singleThread)
			alg = new BackgroundMovingGaussian_PL(0.05f, 16, transform, InterpolationType.BILINEAR, imageType);
		else
			alg = new BackgroundMovingGaussian_PL_MT(0.05f, 16, transform, InterpolationType.BILINEAR, imageType);
