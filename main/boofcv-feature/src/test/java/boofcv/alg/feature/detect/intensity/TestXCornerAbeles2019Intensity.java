 ...
 * @author Peter Abeles
 */
class TestXCornerAbeles2019Intensity extends BoofStandardJUnit {

	int width = 30;
	int height = 20;

	@Test
	void compareAndReshapeOutput() {
		GrayF32 input = new GrayF32(width,height);
		GrayF32 found = input.createNew(1,1);
		...
		XCornerAbeles2019Intensity.process(input,found);
