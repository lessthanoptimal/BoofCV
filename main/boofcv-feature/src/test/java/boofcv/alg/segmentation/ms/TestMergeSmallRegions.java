...
public class TestMergeSmallRegions extends BoofStandardJUnit {
	...
	@Test void process() {
		...
		var pixelToRegion = new GrayS32(10, 9);
		...
		var alg = new MergeSmallRegions<GrayU8>(3, ConnectRule.FOUR, mean);
		...
		var memberExpected = new DogArray_I32(3);
	...
	@Test void setupPruneList() {
		...
		var alg = new MergeSmallRegions<>(11, ConnectRule.FOUR, null);
	...
	@Test void findAdjacentRegions_center() {
		int N = 9;
		var pixelToRegion = new GrayS32(5, 4);
		pixelToRegion.data = new int[]
				{1, 1, 1, 1, 1,
						1, 2, 3, 4, 1,
						1, 5, 6, 7, 1,
		...
		var alg = new MergeSmallRegions<>(10, ConnectRule.FOUR, null);
	...
	@Test void findAdjacentRegions_bottom() {
		...
		var alg = new MergeSmallRegions<GrayF32>(10, ConnectRule.FOUR, null);
		alg.initializeMerge(N);
	...
	@Test void selectMerge() {
		...
		var n = (MergeSmallRegions.Node)alg.pruneGraph.grow();
	...
	private void checkNode( MergeSmallRegions<?> alg, int[] edges, int pruneId ) {
	...
	@Test void adjacentInner4() {
		...
		alg.segmentPruneFlag.resize(N + 1);
		alg.pruneGraph.reset();
	...
	@Test void adjacentInner8() {
		...
		var alg = new MergeSmallRegions<>(10, ConnectRule.EIGHT, null);
		alg.initializeMerge(N);
