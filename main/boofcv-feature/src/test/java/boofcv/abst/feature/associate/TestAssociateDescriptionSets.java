 ...
 * @author Peter Abeles
 */
class TestAssociateDescriptionSets extends BoofStandardJUnit {

	@Test
	void matchedOnlyWithinSets() {
		AssociateDescriptionSets<TupleDesc_F64> alg = createAlg();
		alg.initialize(2);
	...
	protected AssociateDescriptionSets<TupleDesc_F64> createAlg() {
		return new AssociateDescriptionSets<>(FactoryAssociation.greedy(
	...
	private static class ConvertAssociateSets<Desc> extends AssociateDescriptionSets<Desc> implements AssociateDescription<Desc>
	{
