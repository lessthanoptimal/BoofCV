...
public class TestGeneralToInterestPoint extends BoofStandardJUnit {
	...
	ImageGradient<GrayF32, GrayF32> gradient = FactoryDerivative.gradientSB(DerivativeType.SOBEL, GrayF32.class, null);
	...
	@Test void various() {
		...
		var alg = new GeneralToInterestPoint<>(detector, gradient, 2.5);
	...
	@Test void checkMinimumsMaximums() {
		...
		alg = new GeneralToInterestPoint<>(detector, gradient, 2.5);
		alg.detect(input);
		assertEquals(1, alg.getNumberOfSets());
