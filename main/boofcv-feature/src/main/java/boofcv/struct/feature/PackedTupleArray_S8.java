 ...
 * @author Peter Abeles
 */
public class PackedTupleArray_S8 implements PackedTupleArray<TupleDesc_S8> {
	...
	@Override public PackedTupleArray_S8 reset() {
		numElements = 0;
		array.reset();
		return this;
	}
	...
	@Override public void forIdx( int idx0, int idx1, ProcessIndex<TupleDesc_S8> op ) {
		int pointIndex = idx0;
		idx0 *= dof;
		idx1 *= dof;
