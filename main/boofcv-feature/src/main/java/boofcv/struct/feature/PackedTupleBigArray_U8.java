...
public class PackedTupleBigArray_U8 implements PackedTupleArray<TupleDesc_U8> {
	...
	@Override public PackedTupleBigArray_U8 reset() {
		numElements = 0;
		array.reset();
		return this;
	}

	@Override public PackedTupleBigArray_U8 reserve( int numTuples ) {
	...
	@Override public void forIdx( int idx0, int idx1, ProcessIndex<TupleDesc_U8> op ) {
