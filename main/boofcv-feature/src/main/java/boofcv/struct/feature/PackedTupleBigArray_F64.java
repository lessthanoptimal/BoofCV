...
public class PackedTupleBigArray_F64 implements PackedTupleArray<TupleDesc_F64> {
	...
	@Override public PackedTupleBigArray_F64 reset() {
		numElements = 0;
		array.reset();
		return this;
	}
	...
	@Override public PackedTupleBigArray_F64 reserve( int numTuples ) {
	...
	@Override public void forIdx( int idx0, int idx1, ProcessIndex<TupleDesc_F64> op ) {
