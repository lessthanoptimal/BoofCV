 ...
 * @author Peter Abeles
 */
public class SurfPlanar_to_DetectDescribe<T extends ImageGray<T>, II extends ImageGray<II>>
	...
	public SurfPlanar_to_DetectDescribe( DetectDescribeSurfPlanar<II> alg,
