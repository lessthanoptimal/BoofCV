...
public class WrapVisOdomPixelDepthPnP<T extends ImageGray<T>>
	...
	public void setCalibration( StereoParameters parameters ) {
		...
		Point2Transform2_F64 leftPixelToNorm = createNarrowLensDistortion(l).undistort_F64(true, false);
		Point2Transform2_F64 leftNormToPixel = createNarrowLensDistortion(l).distort_F64(false, true);
