 ...
 * @author Peter Abeles
 */
public class TestCalibPoseAndPointRodriguesJacobianS {
	...
	private void check( boolean ...known ) {
		...
		CalibPoseAndPointRodriguesJacobianS alg = new CalibPoseAndPointRodriguesJacobianS();
...
//		DerivativeChecker.jacobianPrint(func, jac, param, 1e-6);
		assertTrue(DerivativeChecker.jacobian(func, jac, param, 1e-4));
	}
}