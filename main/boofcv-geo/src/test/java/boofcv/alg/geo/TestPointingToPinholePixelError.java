...
public class TestPointingToPinholePixelError extends BoofStandardJUnit {
	...
	public TestPointingToPinholePixelError() {
	...
	@Test void usingPoints() {
		var alg = new PointingToPinholePixelError(fx, fy, skew);
