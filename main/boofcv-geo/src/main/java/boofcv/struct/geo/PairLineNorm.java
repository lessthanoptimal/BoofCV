...
public class PairLineNorm implements MapFormattable {
	...
	public PairLineNorm setTo( Vector3D_F64 l1, Vector3D_F64 l2 ) {
		this.l1.setTo(l1);
		this.l2.setTo(l2);
		return this;
	}
	...
	@Override public String formatMap( MapPrintFormat format ) {
		return format.itemPrefix +
				format.pair("l1", l1.formatMap(format), true) +
				format.pair("l2", l2.formatMap(format), false) +
				format.itemSuffix;
	}
