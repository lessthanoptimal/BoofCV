...
public class BundleCameraNumericJacobian {
	...
	double[] X = new double[3]; // storage for camera point as an array
	...
	private FunctionOfPoint funcPoint = new FunctionOfPoint();
	private FunctionOfIntrinsic funcIntrinsic = new FunctionOfIntrinsic();
