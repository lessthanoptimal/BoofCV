...
public class RefineDualQuadraticAlgebra extends SelfCalibrationBase {
	...
	@Getter ConfigConverge converge = new ConfigConverge(1e-6, 1e-5, 100);

	// toggles for assumptions about calibration matrix
	private @Getter @Setter boolean zeroPrinciplePoint = false;
	private @Getter @Setter boolean zeroSkew = false;
	private @Getter @Setter boolean fixedAspectRatio = false;
...
//		optimizer.setVerbose(System.out,0);
	...
	/**
	 * Computes the absolute dual quadratic from the first camera parameters and plane at infinity
	 *
