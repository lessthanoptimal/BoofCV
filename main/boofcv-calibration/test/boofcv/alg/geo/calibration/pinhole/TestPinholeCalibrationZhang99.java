...
// TODO estimate cameras VFOV and HFOV
	...
	// TODO provide some way to cycle through different permutations of the configurations
public class TestPinholeCalibrationZhang99 extends GenericCalibrationZhang99<CameraPinholeRadial> {

	@Override
	public Zhang99IntrinsicParam createEmptyParam() {
		return new CalibParamPinholeRadial(true,2,true);
	}
