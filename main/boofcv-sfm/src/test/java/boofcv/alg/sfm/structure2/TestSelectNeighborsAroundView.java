...
public class TestSelectNeighborsAroundView {
	...
	void pruneViews() {
		...
		{
			alg.maxViews -= 1;
			PairwiseImageGraph2.Motion m = seed.pview.connections.get(0);
	...
	void scoreForRemoval() {
		...
		var v = new PairwiseImageGraph2.View();
		var m0 = new PairwiseImageGraph2.Motion();
		m0.countF = 999;
	...
	private void addViewForRemoval( String id, PairwiseImageGraph2.View src, int motionScore,
									SelectNeighborsAroundView alg ) {
		var workView = new SceneWorkingGraph.View();
		workView.pview = new PairwiseImageGraph2.View();
		workView.pview.id = id;
		var m = new PairwiseImageGraph2.Motion();
	...
	private void createInliers( SceneWorkingGraph.View v, int idx0, int idx1,
		...
		for (int i = idx0; i <= idx1; i++) {
			PairwiseImageGraph2.View pv = working.viewList.get(i).pview;
