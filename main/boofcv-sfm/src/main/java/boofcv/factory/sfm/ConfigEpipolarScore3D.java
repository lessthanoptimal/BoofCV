...
/**
 * Configuration for implementations of {@link boofcv.alg.sfm.structure.EpipolarScore3D}.
 *
 * @author Peter Abeles
 */
public class ConfigEpipolarScore3D implements Configuration {
	...
	/**
	 * Configuration for {@link boofcv.alg.sfm.structure.score3d.ScoreRatioFundamentalHomography}
	 */
	...
	/**
	 * Configuration for {@link boofcv.alg.sfm.structure.score3d.ScoreFundamentalReprojectionError}
	 */
