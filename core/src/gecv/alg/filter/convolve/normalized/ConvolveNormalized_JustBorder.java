 ...
 * 
 * <p>
 * NOTE: Do not modify.  Automatically generated by {@link GenerateConvolveNormalizedNaive}.
 * </p>
 * 
 * @author Peter Abeles
 */
...
public class ConvolveNormalized_JustBorder {
	...
	public static void convolve(Kernel2D_F32 kernel, ImageFloat32 input, ImageFloat32 output ) {
		...
		for (int y = 0; y < height; y++) {
			...
			int maxI = y < height - radius ?  radius : y - (height-radius+1);
