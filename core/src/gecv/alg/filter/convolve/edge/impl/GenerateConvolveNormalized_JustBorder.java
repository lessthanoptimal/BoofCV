...
public class GenerateConvolveNormalized_JustBorder {
	...
	public void generate() {
		...
		printAllOps("I32", "ImageInt8","ImageInt8","int","byte","byte","int"," & 0xFF");
		printAllOps("I32", "ImageInt16","ImageInt16","int","short","short","int","");
		out.println("}");
	}
	...
	private void printHorizontal( String kernelType , String inputType , String outputType ,
		...
		out.print("\t/**\n" +
				...
				"\t */\n" +
				"\tpublic static void horizontal(Kernel1D_"+kernelType+" kernel, "+inputType+" input, "+outputType+" output ) {\n" +
	...
	private void printVertical( String kernelType , String inputType , String outputType ,
		...
		out.print("\t/**\n" +
				...
				"\t * @param output Where the resulting image is written to. Modified.\n" +
				"\t */\n" +
				"\tpublic static void vertical(Kernel1D_"+kernelType+" kernel, "+inputType+" input, "+outputType+" output ) {\n" +
				"\t\tfinal "+inputData+"[] dataSrc = input.data;\n" +
				"\t\tfinal "+outputData+"[] dataDst = output.data;\n" +
				"\t\tfinal "+kernelData+"[] dataKer = kernel.data;\n" +
				"\n" +
