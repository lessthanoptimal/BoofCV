...
public class GenerateConvolveStandardSparse {
	...
	public void generate() {
		...
		printAllOps("I32", "ImageInt8","int"," & 0xFF",false);
		printAllOps("I32", "ImageInt8","int"," & 0xFF",true);
		printAllOps("I32", "ImageInt16","int","",false);
		printAllOps("I32", "ImageInt16","int","",true);
		out.println("}");
	}
