 ...
 * @author Peter Abeles
 */
public class GenerateConvolvedDownNoBorderUnrolled {
	...
	public void addConvolveDiv(int num ) {
		...
		out.print("\t{\n" +
				...
				"\n" +
				"\t\tfinal int radius = kernel.getRadius();\n" +
				"\t\tfinal "+sumType+" totalRow[] = new int[ width ];\n"+
				"\n" +
				"\t\tfinal int offset = radius <= skip ? skip : radius + radius % skip;\n" +
				"\n" +
				"\t\tfor( int y = offset; y < height-radius; y += skip) {\n" +
	...
	public static void main(String args[]) throws FileNotFoundException {
		GenerateConvolvedDownNoBorderUnrolled a = new GenerateConvolvedDownNoBorderUnrolled();
