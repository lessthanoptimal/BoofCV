 ...
 * 
 * <p>
 * DO NOT MODIFY: This class was automatically generated by {@link GenerateConvolvedDownNoBorderUnrolled}.
 * </p>
 *
 * @author Peter Abeles
 */
public class ConvolveDownNoBorderUnrolled_U8_I8_Div {
	public static boolean horizontal( Kernel1D_I32 kernel ,
								   ImageUInt8 image, ImageInt8 dest , int skip, int divisor) {
		switch( kernel.width ) {
			case 3:
	...
	public static void convolve3( Kernel2D_I32 kernel, ImageUInt8 input, ImageInt8 output, int skip , int divisor )
	{
		final byte[] dataSrc = input.data;
		final byte[] dataDst = output.data;
	...
	public static void convolve5( Kernel2D_I32 kernel, ImageUInt8 input, ImageInt8 output, int skip , int divisor )
	{
		final byte[] dataSrc = input.data;
		final byte[] dataDst = output.data;
	...
	public static void convolve7( Kernel2D_I32 kernel, ImageUInt8 input, ImageInt8 output, int skip , int divisor )
	{
		final byte[] dataSrc = input.data;
		final byte[] dataDst = output.data;
	...
	public static void convolve9( Kernel2D_I32 kernel, ImageUInt8 input, ImageInt8 output, int skip , int divisor )
	{
		final byte[] dataSrc = input.data;
		final byte[] dataDst = output.data;
	...
	public static void convolve11( Kernel2D_I32 kernel, ImageUInt8 input, ImageInt8 output, int skip , int divisor )
	{
		final byte[] dataSrc = input.data;
		final byte[] dataDst = output.data;
