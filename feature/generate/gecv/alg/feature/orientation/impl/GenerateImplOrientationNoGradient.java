 ...
 * @author Peter Abeles
 */
public class GenerateImplOrientationNoGradient extends CodeGeneratorBase {
	...
	private void printClass( AutoTypeImage imageType ) throws FileNotFoundException {
		...
		setOutputFile("ImplOrientationNoGradient_"+imageType.getAbbreviatedType());
		printPreamble();
		printFunctions();
	...
	private void printPreamble() {
		...
		out.print("import gecv.alg.feature.orientation.OrientationNoGradient;\n" +
				...
				" * @author Peter Abeles\n" +
				" */\n" +
				"public class "+className+" extends OrientationNoGradient<"+type+"> {\n" +
				"\n" +
	...
	public static void main( String args[] ) throws FileNotFoundException {
		GenerateImplOrientationNoGradient app = new GenerateImplOrientationNoGradient();
		app.generate();
	}
}
