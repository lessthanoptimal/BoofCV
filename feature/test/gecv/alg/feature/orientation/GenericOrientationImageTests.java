...
/**
 * Generic tests for implementers of {@link gecv.alg.feature.orientation.OrientationGradient}.
 *
 * @author Peter Abeles
 */
public class GenericOrientationImageTests<T extends ImageBase> {
	...
	public void checkSubImages() {
		...
		T sub = (T)image.subimage(0,0,regionSize,regionSize);
