 ...
 * @author Peter Abeles
 */
public class KannalaBrandtPlanarPanel extends CalibratedPlanarPanel<CameraKannalaBrandt> {
	...
	public KannalaBrandtPlanarPanel() {
	...
	@Override
	public void setCalibration( CameraKannalaBrandt intrinsic, SceneStructureMetric scene ) {
	...
	@Override
	public void setCorrection( CameraKannalaBrandt param ) {
