 ...
 * @author Peter Abeles
 */
public class ExampleWebcamObjectTrackingGst<T extends ImageBase<T>> extends JPanel
	 ...
	 */
	public ExampleWebcamObjectTrackingGst( TrackerObjectQuad<T> tracker,
...
//				FactoryTrackerObjectQuad.meanShiftLikelihood(30,5,255, MeanShiftLikelihoodType.HISTOGRAM,colorType);
		...
		ExampleWebcamObjectTrackingGst app = new ExampleWebcamObjectTrackingGst(tracker,640,480);
