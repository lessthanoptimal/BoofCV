...
public class ExampleFitPolygon {
	...
	static double toleranceAngle= UtilAngle.degreeToRadian(30);//Math.PI/10;
	...
	/**
	 * Detects contours inside the binary image generated by canny.  Only the external contour is relevant.
	 */
