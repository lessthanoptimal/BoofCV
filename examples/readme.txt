...
ant -Dwhich=boofcv.examples.imageprocessing.ExampleBinaryOps run
ant -Dwhich=boofcv.examples.features.ExampleInterestPoint run
ant -Dwhich=boofcv.examples.tracking.ExamplePointFeatureTracker run
