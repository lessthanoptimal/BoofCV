 ...
 * @author Peter Abeles
 */
public class CreateFiducialSquareBinaryPDF extends BaseFiducialSquarePDF {
	...
	public static void main(String[] args) throws IOException {
		...
		CommandParserFiducialSquarePDF parser = new CommandParserFiducialSquarePDF("number");
		...
		parser.execute(args,new CreateFiducialSquareBinaryPDF());
	}
