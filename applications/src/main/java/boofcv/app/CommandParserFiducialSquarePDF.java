 ...
 * @author Peter Abeles
 */
public class CommandParserFiducialSquarePDF {
	...
	public CommandParserFiducialSquarePDF(String nameOfPatterns) {
	...
	public void execute( String []args , BaseFiducialSquarePDF app) throws IOException {
		try {
			parseArguments(args);
		...
		if(app instanceof CreateFiducialSquareBinaryPDF) {
			((CreateFiducialSquareBinaryPDF) app).
