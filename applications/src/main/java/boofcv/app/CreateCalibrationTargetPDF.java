 ...
 * @author Peter Abeles
 */
public class CreateCalibrationTargetPDF {
	...
	public void run() throws IOException {
		...
		CreateCalibrationTargetGeneratorPDF generator =
				new CreateCalibrationTargetGeneratorPDF(fileName+suffix,paperSize,rows,columns,unit);
	...
	public static void main(String[] args) {
		CreateCalibrationTargetPDF generator = new CreateCalibrationTargetPDF();
