 ...
 * @author Peter Abeles
 */
public class CreateCalibrationTargetGeneratorPDF {
	...
	public CreateCalibrationTargetGeneratorPDF(String documentName , PaperSize paper, int rows , int cols , Unit units ) {
		this.paper = paper;
		this.rows = rows;
		this.cols = cols;
		this.units = units;
