...
/**
 * GUI for batch scanning of Micro QR codes.
 *
 * @author Peter Abeles
 */
public class BatchScanMicroQrCodesGui extends BatchProcessControlPanel
	...
	public BatchScanMicroQrCodesGui() {
		...
		textOutputFile.setText("microqr.txt");
	...
	protected void handleStart() {
		...
		var batch = new BatchScanMicroQrCodes();
