 ...
 * @author Peter Abeles
 */
public class CreateFiducialSquareImagePDF extends BaseFiducialSquarePDF {
...
//			System.out.println("  loaded "+imageName);
	...
	public static void main(String[] args) throws IOException {
		...
		CommandParserFiducialSquarePDF parser = new CommandParserFiducialSquarePDF("image path");
		...
		parser.execute(args,new CreateFiducialSquareImagePDF());
	}
}
