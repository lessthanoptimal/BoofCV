...
public class DetectBlackPolygonControlPanel extends StandardAlgConfigPanel
	...
	public DetectBlackPolygonControlPanel( ShapeGuiListener owner,
		...
		addLabeled(spinnerMinEdgeD, "Edge Intensity D: ", "Minimum intensity after detection");
		addLabeled(spinnerMinEdgeR, "Edge Intensity R: ", "Minimum intensity after refinement");
