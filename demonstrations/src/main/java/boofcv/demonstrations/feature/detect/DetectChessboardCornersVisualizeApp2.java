 ...
 * @author Peter Abeles
 */
public class DetectChessboardCornersVisualizeApp2
		extends DemonstrationBase
{
	...
	DetectChessboardCorners2Pyramid<GrayF32> detector = new DetectChessboardCorners2Pyramid<>(ImageType.SB_F32);
	...
	public DetectChessboardCornersVisualizeApp2(List<PathLabel> examples ) {
...
//			controlPanel.zoom = scale; // prevent it from broadcasting an event
	...
	public static void main( String args[] ) {
		...
		SwingUtilities.invokeLater(()->{
			DetectChessboardCornersVisualizeApp2 app = new DetectChessboardCornersVisualizeApp2(examples);
